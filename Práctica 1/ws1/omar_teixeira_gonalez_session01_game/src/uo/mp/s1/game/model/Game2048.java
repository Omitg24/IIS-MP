...
public class Game2048 {
	...
	//Constantes
	public static final int MIN_DIMENSION=3;	//Dimensión minima necesaria de la matriz
	public static final int MAX_DIMENSION=10;	//Dimensión máxima necesaria de la matriz
