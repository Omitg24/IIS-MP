...
public abstract class Transaction {
	...
	public Transaction(String date, String number, double amount,
			String description) {
		super();
		ArgumentChecks.isTrue(date!=null && !date.trim().isEmpty(), 
				"La fecha no cumple los requisitos");
		ArgumentChecks.isTrue(number!=null && !number.trim().isEmpty(),
				"El numero no cumple los requisitos");
		ArgumentChecks.isTrue(amount>0, "La cantidad no cumple los requisitos");
