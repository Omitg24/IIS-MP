...
public class Game2048WithIntParamTest {
	 ...
	 *  4- La dimensión está por debajo del limite inverior -> Crea un tablero 3x3
	 *  5- La dimensión está por encima del límite superior -> Crea un tablero 3x3
	 */
	...
	/**
	 * 1- La dimensión está dentro de los limites -> Crea el tablero
	 * GIVEN Game recibe una dimensión y crea una matriz con esa dimension (nº_filasXnº_columnas) 
	...
	/**
	 * 4- La dimensión está por debajo del limite inverior -> Crea un tablero 3x3
	 * GIVEN Game recibe una dimensión incorrecta (inferior al limite inferior) y crea una matriz con 3x3 
	 * y se crea una matriz esperada
	 * WHEN 
	 * THEN Compara que sea igual la matriz de game con la esperada
	 */
	...
	/**
	 * 5- La dimensión está por encima del límite superior -> Crea un tablero 3x3
	 * GIVEN Game recibe una dimensión incorrecta (superior al limite superior) y crea una matriz con 3x3 
	 * y se crea una matriz esperada
	 * WHEN 
	 * THEN Compara que sea igual la matriz de game con la esperada
	 */
