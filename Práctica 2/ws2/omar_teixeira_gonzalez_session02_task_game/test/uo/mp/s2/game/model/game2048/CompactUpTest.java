...
public class CompactUpTest {
	...
	/**
	 * Pruebas del método compactUp de la clase Game2048:
	 ...
	 * 5- Compactar hacia arriba matriz semillena compactada hacia abajo 1
	 * 6- Compactar hacia arriba matriz semillena compactada hacia abajo 2
	 * 7- Compactar hacia arriba matriz semillena ya compactada hacia arriba 1
	 * 8- Compactar hacia arriba matriz semillena ya compactada hacia arriba 2
	 */
	
	/**
	 * 1- Compactar hacia arriba matriz semillena 1
	 * GIVEN Game recibe una matriz semillena y se crea la matriz esperada
	 * WHEN Se llama al método compactUp
	...
	public void testCompactUpSemifull1() {
		...
		game.compactUp();
		int[][] expected = CodeForTest.SEMIFULL11;
	...
	public void testCompactUpSemifull4() {
		...
		game.compactUp();
		int[][] expected = {{2,2,2},{2,2,2},{0,0,0}};
		assertArrayEquals (expected, game.getBoard());
	}
