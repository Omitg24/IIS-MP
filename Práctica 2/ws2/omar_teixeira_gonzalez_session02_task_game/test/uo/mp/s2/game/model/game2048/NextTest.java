...
public class NextTest {
	...
	/**
	 * Pruebas del método next de la clase Game2048:
	 * 1- Primera ejecución de next
	 * 2- Segunda ejecución de next
	 * 3- Tercera ejecución de next
	 * 4- Cuarta ejecución de next
	 * 5- Quinta ejecución de next
	 * 6- Sexta ejecución de next
	 * 7- Séptima ejecución de next
	 * 8- Octava ejecución de next
	 * 9- Novena ejecución de next
	 */
	
	/**
	 * 1- Primera ejecución de next
	 * GIVEN Game llama al constructor sin parámetros, que crea una matriz 3x3 de 0s
	 * WHEN Se llama al método next dentro de un bucle while, 
	 * que ejecuta el método un numero determinado de veces
	 * THEN Compara que un valor dado es igual a la suma de los elementos de la matriz 
	 * obtenida (con el next) en el método getSum de la clase CodeForTest 
	 */
	@Test
