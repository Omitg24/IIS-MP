package uo.mp.s2.analyzer.model;
 ...
 *</p>
 * Descripcion: Clase que analiza palabras
 * 
...
public class WordAnalyzer {
	...
	public WordAnalyzer(String aWord) {
		ArgumentsCheck.isTrue(aWord !=null,"Esperaba palabra y fue null");
		ArgumentsCheck.isTrue(aWord.trim().length()>0,"Esperaba palabra y fue null");
		word = aWord;
	}
	
	/**
	 * Método que devuelve el valor del atributo word
	 * 
	 * @return word, palabra introducida en el set
	 */
