...
public class ToHtmlFormatTest {
	...
	/**
	 * Pruebas del método toHtmlFormat de la clase TheSocialNetwork:
	 * 1- Un mensaje
	 * 2- Una foto
	 * 3- Varios mensajes
	 * 4- Varias fotos
	 ...
	 * WHEN Se añade un post y se convierte a HTML
	 ...
	 * 3- Varios mensaje
	 * GIVEN Se crean varios post y la red social
	 * WHEN Se añaden varios post y se convierten a HTML
	 * THEN Se comprueba que el formato resultante es correcto
	 */
	@Test
	 ...
	 * 5- Muchos mensajes y fotos 
	 * GIVEN Se crean varios post y la red social
	 * WHEN Se añaden todos los post y se convierten a HTML
	 * THEN Se comprueba que el formato resultante es correcto
	 */
	@Test
