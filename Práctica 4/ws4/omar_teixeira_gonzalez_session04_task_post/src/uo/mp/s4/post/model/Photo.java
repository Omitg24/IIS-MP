...
public class Photo extends Post {
	...
	/**
	 * Método que devuelve el valor del atributo file
	 * 
	...
	/**
	 * Método que modifica el valor del atributo file
	 * 
	 * @param file, fichero donde se almacena la foto, de tipo String
	 */
	...
	/**
	 * Método que imprime los datos de la foto, por ejemplo: User, File, Likes, Comentarios.
	 * 
	...
	/**
	 * Método que devuelve varios datos de la foto
	 * 
	...
	/**
	 * Método que transforma los ficheros a formato HTML
	 * 
	 * @return HTML format of the file
	 */
	public String toHtmlFormat() {
		return "<img src= " + getFile() + "> </img>";
	}
}
