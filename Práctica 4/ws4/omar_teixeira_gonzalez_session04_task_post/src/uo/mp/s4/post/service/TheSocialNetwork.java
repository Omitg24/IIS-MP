...
//Atributos:
	...
	/**
	 * Método que devuelve el numero de posts que hay en la lista
	 * 
	 ...
	 * 
	 * @return htmlList, lista con los posts en formato HTML
	 */
	public ArrayList<String> toHtmlFormat(){
		ArrayList<String> htmlList = new ArrayList<String>();
		for (int i=0; i<posts.size();i++) {
			htmlList.add(posts.get(i).toHtmlFormat());
		}
		return htmlList;
	}
}