...
public class ShootAtTest {
	...
	public void testEmptySpace() {		
		boolean test = board.shootAt(coords1);
	...
	public void testEmptySpace2Times() {		
		boolean test = board.shootAt(coords1);
		boolean test2 = board.shootAt(coords1);
		assertEquals(-10, board.getBoard()[coords1.getRow()][coords1.getCol()]);
		assertFalse(test);
		assertFalse(test2);
	}
	...
	public void testShipSpace() {
		boolean test = board.shootAt(coords2);
	...
	public void testShipSpace2Times() {
		boolean test = board.shootAt(coords3);
		boolean test2 = board.shootAt(coords3);
		assertEquals(-4, board.getBoard()[coords3.getRow()][coords3.getCol()]);
		assertTrue(test);			
		assertTrue(test2);
	}
}
