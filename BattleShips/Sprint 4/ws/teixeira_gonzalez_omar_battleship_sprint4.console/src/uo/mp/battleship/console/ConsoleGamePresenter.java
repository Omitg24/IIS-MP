...
public class ConsoleGamePresenter implements GamePresenter{
	...
	/**
	 * Método que muestra el titulo y las letras de los tableros
	 * 
	 * @param board, tablero para sacar el tamaño
	 */
	private void showTitles(Board board) {		
	...
	public void showWinner(Player theWinner) {
		...
		System.out.println("\nThe winner is " + theWinner.getName() + ". Congratulations!!!");
	}
	...
	public void showHitOrMiss(int impact) {
		ArgumentChecks.isTrue(impact>=0 && impact<=2);
		if (impact==1) {
	...
	public void showTurn(Player player) {
		ArgumentChecks.isTrue(player!=null);
	...
	public void showShootingAt(Coordinate coordinate) {
		ArgumentChecks.isTrue(coordinate!=null);
