...
public class SearchItemTest {
	 ...
	 * Atributo searched
	 */
	private Item searched1;
	
	/**
	 * Atributo searched
	 */
	private Item searched2;
	
	/**
	 * Atributo searched
	 */
	private Item searched3;
	
	/**
	 * Atributo searched
	 */
	private Item searched4;
	...
	public void SetUp() {
		...
		searched1 = new VideoGame("God of War (2018)","Cory Barlog", 1, Platform.PLAYSTATION);
		searched2 = new Cd("TIM", "Avicii", 12, 38);
		searched3 = new Dvd ("Inception","Christopher Nolan", 162);
		searched4 = new VideoGame ("Batman: Arkham Knight","Sefton Hill",1, Platform.XBOX);
		gameSearchFail = new VideoGame("The Last of Us", "Neil Druckmann", 1, Platform.PLAYSTATION);
		lib.add(cd1);
		lib.add(cd2);
		lib.add(dvd1);
		lib.add(dvd2);
...
//Pruebas de funcionalidad:
	 ...
	 */
	 ...
	 public void testSearchItemOne() {
		 assertEquals(4,lib.searchItem(searched1));
	 }
	 ...
	 */
	 ...
	 public void testSearchItemMany() {
		 assertEquals(0,lib.searchItem(searched2));
		 assertEquals(2,lib.searchItem(searched3));
		 assertEquals(4,lib.searchItem(searched1));
		 assertEquals(5,lib.searchItem(searched4));
	 }
