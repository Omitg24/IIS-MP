...
public class Application {
	...
	public static void run() {
		...
		Message msg2 = new Message("ElPlayerHD","Aqui verás ejemplos de lo que es posible");
		Message msg3 = new Message("DaneonX","Y aun queda mucho más por venir");
		...
		//Se añaden a la red social (lista):
		...
		//Llamada a los métodos de TheSocialNetwork
