...
//Atributos:
	...
	private void handleSystemError(RuntimeException e) {
		String str = "Ha habido un error\n" + e.getMessage() + " por favor, contacte con el administrador";
		Console.printf(str);
		Logger.log(str);
	}

	private void handleUserError(Exception e) {
		String str = "Ha habido un error\n" + e.getMessage() + " por favor, intentelo de nuevo";
		Console.printf(str);
	}
	...
	private void processOption(int option) throws NewsStandException, IOException {
		...
		case 9:
			...
			break;
		case 10:
			sortPublicationsBySales();
			break;
		case 11:
			sortOrdersByQuantityAndNames();
			break;
		}
	}
	 ...
	 */
	private void sortOrdersByQuantityAndNames() {
		newsStand.sortOrdersByQuantityAndNames();
