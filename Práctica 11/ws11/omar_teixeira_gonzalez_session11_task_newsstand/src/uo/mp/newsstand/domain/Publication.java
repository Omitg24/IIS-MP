...
public abstract class Publication implements Comparable<Publication> {
	...
	/**
	 * Constructor con parámetros name, stock y sales
	 * 
	 * @param name,  nombre
	 * @param stock, stock
	 * @param sales, ventas
	...
	/**
	 * Método que devuelve el valor del atributo sales
	 * 
	 * @return sales, ventas
	 */
	public int getSales() {
	...
	/**
	 * Método que devuelve el hashCode del objeto
	 * 
	...
	/**
	 * Método que compara si un objeto es igual a otro
	 * 
	 * @param obj, objeto
	...
	public boolean equals(Object obj) {
		...
		if (name == null) {
			...
			return false;
		} else if (!name.toString().equals(obj.toString())) {
			return false;
		}
		return true;
	}
	...
	/**
	 * Comparador natural de publicaciones
	 *
	 * @param pub1, publicacion a comparar
	 * @return int, comparación
	 */
	@Override
	public int compareTo(Publication pub1) {
		return this.getName().compareTo(pub1.getName());
	}
}
