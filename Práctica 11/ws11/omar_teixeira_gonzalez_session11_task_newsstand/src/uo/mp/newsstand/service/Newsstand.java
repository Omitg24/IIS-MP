...
import uo.mp.newsstand.domain.comparators.QuantityAndNamesComparator;
import uo.mp.newsstand.domain.comparators.SalesComparator;
...
public class Newsstand {
	 ...
	 * @throws IOException
	 */
	public void importPublicationsFromZipFile(String fileName) throws InvalidFileNameException, IOException {
	...
	/**
	 * Método que ordena las publicaciones por nombre
	 */
	...
	/**
	 * Método que ordena las publicaciones por ventas
	 */
	public void sortPublicationsBySales() {
		Collections.sort(publications, new SalesComparator());
	}

	/**
	 * Método que ordena los pedidos por cantidad o por nombre
	 */
	public void sortOrdersByQuantityAndNames() {
		Collections.sort(orders, new QuantityAndNamesComparator());
	}
}
