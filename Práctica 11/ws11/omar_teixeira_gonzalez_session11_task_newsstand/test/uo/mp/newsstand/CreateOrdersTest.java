...
public class CreateOrdersTest {
	...
	/**
	 * Pruebas del método createOrders de la clase Newsstand: 
	 * 1- Con periodico 
	 * 2- Con revista
	 * 3- Vacía
	 */
	...
	/**
	 * 1- Con periodico GIVEN Se crea un kiosko, se añaden publicaciones WHEN Se
	 * llama al método create orders THEN Se comprueba que los objetos creados son
	 * los mismos
	 * 
	 * @throws AlreadyExistsException
	 */
	@Test
	public void newspaperTest() throws AlreadyExistsException {
		int SALES = 15;
		int STOCK = 1;
	...
	/**
	 * 2- Con revista GIVEN Se crea un kiosko, se añaden publicaciones WHEN Se llama
	 * al método create orders THEN Se comprueba que los objetos creados son los
	 * mismos
	 * 
	 * @throws AlreadyExistsException
	 */
	@Test
	public void magazineTest() throws AlreadyExistsException {
		int SALES = 15;
	 ...
	 * WHEN Se llama al createOrders
	 * THEN Se comprueba que no hay pedidos
	 */
	@Test
	public void testNoPublications() {
		ns.createOrders();
